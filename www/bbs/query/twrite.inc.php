...
// echo "echo:" . $jb_code . "<br>" ;
// echo "echo:" . $jb_title . "<br>" ;
// echo "echo:" . $jb_name . "<br>" ;
// echo "echo:" . $jb_content . "<br>" ;
// exit;
//쓰기권한
...
//온라인 신청 번호
if($jb_code == "70"){
    $jb_etc1 =  $jb_mobile1 . "-" . $jb_mobile2 . "-" . $jb_mobile3;
}
...
if ($is_fileName) {
	...
	$args_f['max_file_size'] 		= 1024 * 400720; //40MB 이하
