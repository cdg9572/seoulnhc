<?
            ...
            elseif($jb_code == "40"  || $jb_code == "50" || $jb_code == "60"){$title = "자료실";}
            ?>
            <div class="cont-tit">
                <h3><?=$title?></h3>
            </div>
            <?
                 if($jb_code == "40" or $jb_code == "50" or $jb_code == "60" ){
                    if($jb_code == "40"){$class1 = "class='active'";}
                    elseif($jb_code == "50"){$class2 = "class='active'";}
			...
			<div class="tabMenu s-inner">
				...
				<ul>
					...
					<li <?=$class2?>><a href="/notice/notice.php?jb_code=50">영상자료</a></li>
					...
					<table width="100%" class="viewType">
						...
						<tbody>
							...
							<tr class="small-padding">
								...
								<td style="text-align:right"><span class="tit">작성일</span> <strong class="mg-l10"><?=$jb_etc6?></strong></td>
							</tr>                           
							<tr>
							...
							<tr>
								<td style="text-align:left;">
                                <img src="/resource/images/link.png" width="24" alt="">&nbsp;<a href="<?=$jb_homepage?>" target="_blank"> <?=$jb_homepage?> </a>
								</td>
							</tr>
							<?}?>
