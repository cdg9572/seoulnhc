                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?
                                if(isset($check_id) && $check_level>=9){
                                echo "<label class='noti'><input type=\"checkbox\" value=\"Y\" id=\"jb_number_check\" name=\"jb_number_check\" class='chk'> 메인노출</label>";
                                }
                            ?>									
                            </span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>                           
                            <input type="text" name="jb_etc6" id="jb_etc6" value="<?=$_GET['jb_etc6']?>" class="txtInput"  style="width:30%;" >
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <ul>
                                <li>
                                <?php
                                    ($jb_code=="20") ?  $jb_text = " 340 X 216"  : "" ;
                                    //첨부파일의 숫자는 $i의 범위로 조정하면 된다.
                                    for($i=0; $i<1; $i++) { 
                                ?>
                                    <input type="file" name="jb_file[]" class="fileInput txtInput"><?=$jb_text ?>
                                </li>
                                <? } ?>
                            </ul>
                        </td>
