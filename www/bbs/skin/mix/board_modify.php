...
<link rel="stylesheet" type="text/css" href="<?=$GP -> INC_CSS_PATH?>/jquery_ui.css" media="all" />
            ...
            <table width="100%" class="writeType">
                ...
                <tr>
                        ...
                        <select name='jb_type' id='jb_type'  style="border:1px solide #ddd; height:27px; line-height:27px; width:150px;" >
                                <option value='A' <? if($jb_type=="A") echo "selected";?>>일반형</option>
                                <option value='B' <? if($jb_type=="B") echo "selected";?>>링크형</option>                        
                        </select> 
                        </td>
			    </tr>
                <tr>
                ...
                <td>
                    ...
                    if($jb_number=="50")
                        ...
                        $number_checked="";
                    echo "<label class='noti'><input type=\"checkbox\" name=\"jb_number_check\" value=\"Y\" class='chk' ${number_checked}> 메인노출</label>";
                    }
                    ?>
                </td>
                </tr>
                ...
                <tr>
                    <th scope="row">출처</th>
                    <td><input type="text" class="txtInput" title="출처 입력" placeholder="출처" style="width:100%;" id="jb_etc5" name="jb_etc5" value="<?=$jb_etc5?>" /></td>
                </tr>
                <tr>
                    <th scope="row">링크</th>
                ...
                <tr>
                    ...
                    <td>                           
                        <input type="text" name="jb_etc6" id="jb_etc6" value="<?=$jb_etc6?>" class="txtInput"  style="width:30%;" >
                    </td>
                </tr>
                <tr>
                <th scope="row">본문</th>
