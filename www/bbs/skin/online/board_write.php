...
<div class="s-inner">
    ...
    <div class="tabMenu">
        ...
        <ul>
            <li class="active"><a href="/notice/notice.php?jb_code=70">온라인상담 신청</a></li>
            <li><a href="/consulting/page01-2.html">실시간상담 신청</a></li>
            <li><a href="/consulting/page01-3.html">전화상담 신청</a></li>
        </ul>
    </div>
    <!-- //end tab -->
					...
					<table class="writeType">
						...
						<tbody>
							...
							<tr>
								<th>휴대전화번호</th>
								<td class="table-tel">
                                     <input type="text" class="txtInput" title="휴대폰 첫째자리 입력" style="width:100px;" id="jb_mobile1" name="jb_mobile1" maxlength="3" onkeyup="moveCursor(this,3,'jb_mobile2')">
                                   - <input type="text" class="txtInput" title="휴대폰 가운데자리 입력" style="width:100px;" id="jb_mobile2" name="jb_mobile2" maxlength="4" onkeyup="moveCursor(this,4,'jb_mobile3')">
                                   - <input type="text" class="txtInput" title="휴대폰 마지막자리 입력" style="width:100px;" id="jb_mobile3" name="jb_mobile3" maxlength="4">
								</td>
							</tr>
							<tr>
								<th>구분</th>
							...
							<tr>
                                ...
                                <!-- <textarea name="jb_content" id="jb_content" style="display:none" rows="20"></textarea>
									...
									<textarea cols="30" rows="10" style="width:100%;font-weight:500;color:#111;" placeholder="내용을 입력해주세요"></textarea>
								</td>
							</tr>
						</tbody>
					</table>
...
function moveCursor(textbox,num,target){
