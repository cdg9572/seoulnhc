...
if($data_list_cnt > 0) {
	for ($i=0; $i<$data_list_cnt; $i++ ) {
            ...
            $jb_sub_type				= $data_list[$i]['jb_sub_type'];
			...
			$jb_title 					= $C_Func->strcut_utf8($data_list[$i]['jb_title'], 170, true, "...");	//제목 (길이, HTML TAG제한여부 처리)
			...
			if($jb_order < 100) {
                ...
                ($jb_sub_type == "Y") ? $jb_no ="<img class='notice-icon' src='/resource/images/notice_icon3.png' alt='공지'>" :  $jb_no ="" . $num_idx--. "";
