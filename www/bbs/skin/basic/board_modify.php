        ...
        <div class="tableType-01 green">
            <table width="100%" class="writeType">
                ...
                <td>
                    ...
                    if($jb_order=="50") $notice_checked=" checked";
                    else $notice_checked="";

                    ($jb_sub_type == "Y") ? $sub_type_checked = "checked" : "";
                    echo "<label class='noti'><input type=\"checkbox\" name=\"jb_notice_check\" value=\"Y\" class='chk' ${notice_checked}> 공지</label>";
                  //  echo " <label class='noti'><input type=\"checkbox\" value=\"Y\" id=\"jb_sub_type\" name=\"jb_sub_type\" class='chk' ${sub_type_checked}> 중요</label>";
                    }
                    ?>
                </td>
                </tr>
