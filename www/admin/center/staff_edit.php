					...
					<table class="table table-bordered">
						<tbody>                                         
                            <tr>
								<th><span>*</span>부서명</th>
								<td>
                                <textarea name="tm_content1" id="tm_content1" cols="128" rows="5"><?=$tm_content1?></textarea>
								</td>
                            </tr>	
                            <tr>
								<th><span>*</span>이름</th>
                            ...
                            <tr>
								...
								<td>
                                 <textarea name="tm_content4" id="tm_content4" cols="128" rows="5"><?=$tm_content4?></textarea>
								</td>
                            </tr>     
                            <tr>
